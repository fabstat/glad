...
flags.DEFINE_integer("step_stride", 30, help="Stride of steps to skip.")
...
class Render():
    ...
    def render_gif_animation(
            self, point_size=1, timestep_stride=30, vertical_camera_angle=20, viewpoint_rotation=0.5, change_yz=False
    ):
        """
